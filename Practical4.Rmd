...
xgboost_pred <- predict(model, eeg_validate_matrix)
...
```{r nnet evaluation}
# Assuming you have chosen Neural Network (nnet) as the model to evaluate

# Make predictions on the validation data using the Neural Network model
nnet_pred <- predict(model, eeg_validate_matrix)
